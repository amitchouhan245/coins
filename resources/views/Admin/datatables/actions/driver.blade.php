	...
	@else
		...
		@endif	
	  	...
	  	<a class="dropdown-item" href="{{ $app_url.'add-driver/'.$data->id }}" title="Edit Driver"><i class="la la-edit"></i> Edit Driver</a>

	  	<!-- <a class="dropdown-item"  href="{{$app_url.'users/'.$data->id}}" title="User Details"><i class="la la-edit"></i> Details </a> 
 		  	 -->
	  	<a class="dropdown-item" onclick="delete_record('User', '{{ $data->id }}')" href="#" title="Delete Driver" ><i class="la la-trash"></i> Delete </a>   
</div>
