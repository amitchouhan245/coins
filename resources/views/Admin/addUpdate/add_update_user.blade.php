                     ...
                     <div class="card-content collapse show">
                        <div class="card-body">
                          <form class="form" id="userForm" enctype="multipart/form-data"  method="post" action="javascript:void(0)">
                            <div class="form-body">
                              <h4 class="form-section"><i class="la la-user"></i> Users Info</h4>
                                <div class="row">
                                  <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="user_type">Level<i class="error"><strong>*</strong></i></label>
                                      <select class="select2 form-control" name="user_type" id="user_type">
        ...
        if(id != ''){
          ...
          type: method,
					...
					success: function(res) {
						...
						ajax_success(res, '{{ $app_url."users" }}', 'submit2');
