    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12">
          <h3 class="content-header-title"><i class="ft-message-square"></i> {{ $title }}</h3>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Support Chat</h4>
                    ...
                    <table class="table table-striped table-bordered" id="table">
                      <thead>
                        <tr>
                          ...
                          <a class="" href="#" title="Selected record permanently deleted" onclick="bulk_delete_record('Support')"><i class="la la-trash"></i></a>
                          </th>
                        </tr>
                      </thead>
                    </table>
  ...
  <script>
    ...
    $(function() { 
      ...
      $('#table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL + 'support-list',
        columns: [
          {data: 'DT_RowIndex', name: 'DT_RowIndex',className: "first_letter text-center"},
          { data: 'user_name', name: 'user_name', className: "first_letter text-center" },
