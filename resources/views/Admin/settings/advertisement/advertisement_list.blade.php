    ...
    <div class="content-wrapper">
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-6 col-12">
          <div class="btn-group">
             <a href="{{ $app_url.'Advertize' }}" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
              Add New 
             </a>
          </div>
        </div>
                    ...
                    <table class="table table-striped table-bordered" id="table">
                      <thead>
                        <tr>
                          ...
                          <a class="" href="#" title="Selected record permanently deleted" onclick="bulk_delete_record('Advertisement')"><i class="la la-trash"></i></a>
                          </th>
