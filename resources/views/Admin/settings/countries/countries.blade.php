    ...
    <div class="content-wrapper">
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-6 col-12">
          <div class="btn-group">
             <a href="{{ $app_url.'countries/create' }}" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
              Add New Country
             </a>
          </div>
        </div>
                    ...
                    <table class="table table-striped table-bordered" id="table">
                      <thead>
                        <tr>
                          ...
                          <a class="" href="#" title="Selected record permanently deleted" onclick="bulk_delete_record('Country')"><i class="la la-trash"></i></a>
                          </th>
                        </tr>
                      </thead>
                    </table>
  ...
  <script>
    ...
    $(function() { 
      ...
      $('#table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL + 'countries',
        columns: [
          {data: 'DT_RowIndex', name: 'DT_RowIndex',className: "first_letter text-center"},
          { data: 'country_name', name: 'country_name', className: "first_letter text-center" },
