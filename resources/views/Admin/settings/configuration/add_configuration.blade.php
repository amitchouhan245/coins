               ...
               <div class="col-md-8">
                  <div class="card">
                     ...
                     <div class="card-content collapse show">
                        <div class="card-body">
                           <form class="form" id="addConfigurationForm" method="POST">
                              <div class="form-body">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" id="value" class="form-control" placeholder="Value" name="value">
                                       </div>
                                    </div>
  ...
  $(document).ready(function(){
    ...
    $('#addConfigurationForm').validate({
      ...
      submitHandler: function(form) { 
        ...
        var oFormData = $('#addConfigurationForm').serializeArray();

        $.ajax({
       
          url      : APP_URL + 'configuration',
          type     : 'POST', 
          data     : oFormData,
          headers  : headers,
