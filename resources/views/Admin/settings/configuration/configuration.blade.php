    ...
    <div class="content-wrapper">
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-6 col-12">
          <div class="btn-group">
             <a href="{{ $app_url.'configuration/create' }}" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
  ...
  <script>
    ...
    $(function() { 
      ...
      $('#table').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: APP_URL +'configuration',
        columns: [
          {data: 'DT_RowIndex', name: 'DT_RowIndex', className: "text-center" },
          { data: 'title', name: 'title', className: "first_letter text-center" },
          { data: 'type', name: 'reasons', className: "text-center" },
          { data: 'value', name: 'reasons', className: "first_letter text-center" },
