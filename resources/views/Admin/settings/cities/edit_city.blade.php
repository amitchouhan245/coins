               ...
               <div class="col-md-8">
                  <div class="card">
                     ...
                     <div class="card-content collapse show">
                        <div class="card-body">
                           <form class="form" id="editCityForm" method="PUT">
                              <div class="form-body">
                                    ...
                                    <div class="col-md-12">
                                         ...
                                         <select class="select2 form-control" id="country_id" name="country_id" onchange="select_state();">
                                             ...
                                             @foreach($country as $value)
                                               ...
                                               <?php
                                                ...
                                                if ($value->id == $city->state->country_id) {
                                      ...
                                      <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" id="city_name" class="form-control" placeholder="City Name" value="{{ucfirst($city->city_name)}}" name="city_name">
                                       </div>
  ...
  $(document).ready(function(){
    ...
    $('#editCityForm').validate({
      ...
      submitHandler: function(form) { 
        ...
        var oFormData = $('#editCityForm').serializeArray();

        $.ajax({
       
          url      : APP_URL + 'cities/' + '{{ $city->id }}',
          type     : 'PUT',
          data     : oFormData,
          headers  : headers,
        ...
        if (res.code === 200) {
          ...
          for (var i = 0; i < res.result.length; i++) {
             ...
             var ShowSelState = '';
                ...
                if (stateID == res.result[i].id) {

                  ShowSelState = 'selected = "selected"';

                }
               
            options = options + '<option value="' + res.result[i].id + '"' + ShowSelState + '>'+res.result[i].state_name+'</option>';
          } 
        }
