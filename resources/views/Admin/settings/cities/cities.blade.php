    ...
    <div class="content-wrapper">
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-6 col-12">
          <div class="btn-group">
             <a href="{{ $app_url.'cities/create' }}" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
              Add New City
             </a>
          </div>
        </div>
                    ...
                    <table class="table table-striped table-bordered" id="table">
                      <thead>
                        <tr>
                          ...
                          <a class="" href="#" title="Selected record permanently deleted" onclick="bulk_delete_record('City')"><i class="la la-trash"></i></a>
                          </th>
                        </tr>
                      </thead>
                    </table>
    ...
    $(function() { 
      ...
      $('#table').DataTable({
        ...
        columns: [
          ...
          { data: 'city_name', name: 'city_name', className: "first_letter text-center" },
          { data: 'state.state_name', name: 'state.state_name', className: "first_letter text-center" },
          { data: 'state.country.country_name', name: 'state.country.country_name', className: "first_letter text-center" },
