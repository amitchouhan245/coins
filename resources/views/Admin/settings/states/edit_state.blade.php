               ...
               <div class="col-md-8">
                  <div class="card">
                     ...
                     <div class="card-content collapse show">
                        <div class="card-body">
                           <form class="form" id="editStateForm" method="PUT">
                              <div class="form-body">
                                 <h4 class="form-section"><i class="la la-flag-o"></i>Sate Info</h4>
                                 <div class="row">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" id="state_name" class="form-control" placeholder="State Name" value="{{ ucfirst($state->state_name) }}" name="state_name">
                                       </div>
  ...
  $(document).ready(function() {
    ...
    $('#editStateForm').validate({
      ...
      submitHandler: function(form) { 
        ...
        var oFormData = $('#editStateForm').serializeArray();

        $.ajax({
       
          url      : '{{ $app_url.'states/'.$state->id }}',
          type     : 'PUT', 
          data     : oFormData,
          headers  : headers,
