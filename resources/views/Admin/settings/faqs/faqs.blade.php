    ...
    <div class="content-wrapper">
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-right col-md-6 col-12">
          <div class="btn-group">
             <a href="{{ $app_url.'faqs/create' }}" class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
              Add FAQ
             </a>
          </div>
        </div>
                    ...
                    <table class="table table-striped table-bordered" id="table">
                      <thead>
                        <tr>
                          ...
                          <a class="" href="#" title="Selected record permanently deleted" onclick="bulk_delete_record('Faq')"><i class="la la-trash"></i></a>
                          </th>
                        </tr>
                      </thead>
                    </table>
    ...
    $(function() { 
      ...
      $('#table').DataTable({
        ...
        columns: [
          ...
          { data: 'answer', name: 'answer', className: "first_letter text-center"},
          { data: 'status', name: 'Status', orderable: false, searchable: false, className: "first_letter text-center"},           
