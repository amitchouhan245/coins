               ...
               <div class="col-md-8">
                  <div class="card">
                     <div class="card-content collapse show">
                        <div class="card-body">
                           <form class="form" id="addContentForm" method="PUT">
                              <div class="form-body">
                                 ...
                                 <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" id="title" class="form-control" placeholder="Type" name="title" value="{{ ucfirst(@$contents->title) }}">
                                       </div>
                                    </div>
                                  ...
                                  <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" id="type" class="form-control" placeholder="Type" name="type" readonly  value="{{ @$contents->type }}">
                                       </div>
                                    </div>
                                     ...
                                     <!--  <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="value">Value<i class="error"><strong>*</strong></i></label>
                                           <textarea name="ckeditor" id="ckeditor" cols="30" rows="15" class="ckeditor">{{ @$contents->value}}
                                          </textarea> 
                                       </div>
                                    </div> -->
                                     ...
                                     <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="value">English<i class="error"><strong>*</strong></i></label>
                                           <textarea name="eng_ckeditor_v" id="eng_ckeditor_v" cols="30" rows="15" class="ckeditor">{{ @$contents->english}}</textarea> 
                                       </div>
                                    </div>
                                      ...
                                      <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="value">Arabic<i class="error"><strong>*</strong></i></label>
                                           <textarea name="arb_ckeditor_v" id="arb_ckeditor_v" cols="30" rows="15" class="ckeditor">{{ @$contents->arabic}}</textarea> 
                                       </div>
                                    </div>

                                    <input type="hidden" name="id" id="id" value="{{ @$contents->id }}">
  ...
  $(document).ready(function(){
    ...
    $('#addContentForm').validate({
      ...
      submitHandler: function(form) { 
        ...
        var engMessage = CKEDITOR.instances['eng_ckeditor_v'].getData();
        var arbMessage = CKEDITOR.instances['arb_ckeditor_v'].getData();

        oFormData.push({name: 'eng_ckeditor', value: engMessage});
        oFormData.push({name: 'arb_ckeditor', value: arbMessage});

        $.ajax({
       
          url      : APP_URL + "{{ 'contents/'.$contents->id }}",
          type     : 'PUT', 
          data     : oFormData,
          headers  : headers,
